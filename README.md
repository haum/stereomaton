...
Note that LCD driver and its configuration, touchscreen driver, python as well as evdev and pycairo modules are supposed installed on the system for the code present in this repository.
